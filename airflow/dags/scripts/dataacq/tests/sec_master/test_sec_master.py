...
@patch("scripts.dataacq.dataacq.sec_master.sec_master.SecurityMaster.enrich")
...
@patch("scripts.dataacq.dataacq.sec_master.sec_master.SQLUtils.query")
@patch("scripts.dataacq.dataacq.sec_master.sec_master.SecurityMaster.enrich")
@patch("scripts.dataacq.dataacq.sec_master.sec_master.SecurityMaster.get_file_content")
